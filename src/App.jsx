...
/**
 * authStore reads token + user from localStorage synchronously at module init,
 * so these are already populated on the very first render — no flash, no redirect loop.
 */
