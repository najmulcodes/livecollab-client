...
export default function RegisterPage() {
  ...
  const labelStyle = {
    ...
    letterSpacing: '0.1em', color: 'rgba(240,237,232,0.5)', marginBottom: '8px',
  };
    ...
    Start collaborating in real-time
        ...
        <div className="glass p-8" style={{ borderRadius: '2px' }}>
            ...
            {googleLoading
              ...
              : (
                <svg width="16" height="16" viewBox="0 0 24 24">
                  ...
                  <path fill="rgba(232,162,74,0.4)" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
                </svg>
              )
            }
          ...
          <p style={{
            ...
            <Link to="/login" style={{ color: '#e8a24a', textDecoration: 'none', fontWeight: 500 }}>
              Sign in
            </Link>
          </p>
        </div>
