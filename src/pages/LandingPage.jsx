...
<title>LiveCollab — Landing</title>
...
<nav>
  <div class="nav-logo">
    <svg class="logo-icon" viewBox="0 0 32 32" fill="none">
      ...
      <line x1="10" y1="8" x2="27" y2="7" stroke="rgba(232,162,74,0.4)" stroke-width="1.5"/>
    </svg>
    LIVECOLLAB
  </div>
  <ul class="nav-links">
...
<section class="hero">
  ...
  <div class="sunset-orb"></div>
  <div class="horizon-glow"></div>

  <!-- Rock silhouette SVG -->
  <svg class="hero-rock-svg" viewBox="0 0 500 300" fill="none" xmlns="http://www.w3.org/2000/svg">
    <ellipse cx="250" cy="280" rx="200" ry="20" fill="rgba(232,162,74,0.08)"/>
    <!-- Rock body -->
    <path d="M160 240 C155 220 148 200 152 180 C156 160 162 145 170 130 C178 115 188 105 200 98 C212 91 220 92 228 95 C240 90 252 88 262 92 C275 88 285 92 295 100 C308 110 318 125 325 145 C332 165 335 185 332 205 C328 225 322 238 315 248 C290 255 270 258 250 258 C230 258 200 252 180 248 Z" fill="rgba(20,18,14,0.9)" stroke="rgba(232,162,74,0.15)" stroke-width="1"/>
    <!-- Highlight ridge -->
    <path d="M190 145 C205 130 225 122 245 120 C265 118 282 125 295 138" stroke="rgba(232,162,74,0.2)" stroke-width="1.5" fill="none" stroke-linecap="round"/>
    <!-- Reflection in water -->
    <path d="M175 260 C190 268 215 272 250 272 C285 272 315 268 325 260" stroke="rgba(232,162,74,0.08)" stroke-width="1" fill="none"/>
    <path d="M185 270 C205 276 230 279 250 279 C270 279 295 276 315 270" stroke="rgba(232,162,74,0.05)" stroke-width="0.8" fill="none"/>
  </svg>

  <div class="hero-bg"></div>

  <div class="hero-content">
    <p class="hero-eyebrow">THE SMARTEST THING YOU CAN DO</p>
    <h1 class="hero-h1">
      Smarter<br/>
      Collaboration<br/>
      <em>Begins Now</em>
    ...
    <a href="/register" class="hero-cta">
      Start Now <span class="cta-arrow">→</span>
    </a>
  </div>

  <div class="hero-stats">
    <div class="stat-item">
      <div class="stat-num"><span>+</span>83<span>%</span></div>
      <div class="stat-label">Avg team velocity increase</div>
    </div>
    <div class="stat-divider"></div>
    <div class="stat-item">
      <div class="stat-num">3,427</div>
      <div class="stat-label">Active workspaces</div>
    </div>
    <div class="stat-divider"></div>
    <div class="stat-item">
      <div class="stat-num">107<span>k+</span></div>
...
<section id="features">
  <div class="features-layout">
    <div class="features-intro">
      ...
      <h2 class="section-h2">Everything your team needs to move as one</h2>
      <p class="section-desc">Built for speed, clarity, and real-time presence. No overhead. No lag. Just flow.</p>
    </div>
    <div class="feature-list">
      <div class="feature-item">
        <div class="feature-num">01</div>
        <div class="feature-title">Real-Time Sync</div>
        <div class="feature-desc">Every card move and update appears instantly across all sessions — no refresh, zero delay.</div>
      </div>
      <div class="feature-item">
        <div class="feature-num">02</div>
        <div class="feature-title">Live Presence</div>
        <div class="feature-desc">See who's online and exactly what they're working on with live indicators and cursor positions.</div>
      </div>
      <div class="feature-item">
        <div class="feature-num">03</div>
        <div class="feature-title">Kanban Boards</div>
        <div class="feature-desc">Drag and drop cards across columns. Assign priorities, due dates, and teammates to every task.</div>
      </div>
      <div class="feature-item">
        <div class="feature-num">04</div>
        <div class="feature-title">Activity Log</div>
        <div class="feature-desc">Every action is tracked. A full, timestamped history of who did what across your workspace.</div>
      </div>
      <div class="feature-item">
        <div class="feature-num">05</div>
        <div class="feature-title">Invite by Code</div>
        <div class="feature-desc">Share an 8-character code. Teammates join instantly — no email invites, no friction.</div>
      </div>
      <div class="feature-item">
        <div class="feature-num">06</div>
        <div class="feature-title">Secure by Default</div>
        <div class="feature-desc">JWT authentication, hashed passwords, and protected API routes. Secure without configuration.</div>
      </div>
    </div>
  </div>
</section>
...
<section id="how-it-works">
  ...
  <div class="steps-grid">
    <div class="step-card">
      ...
      <div class="step-title">Create a Workspace</div>
      <p class="step-desc">Set up a team workspace in seconds. Choose an icon, color, and name that fits your project.</p>
    </div>
    <div class="step-card">
      <span class="step-number">02</span>
      <div class="step-title">Invite Your Team</div>
      <p class="step-desc">Share the auto-generated invite code. Teammates join instantly — no email required.</p>
    </div>
    <div class="step-card">
      <span class="step-number">03</span>
      <div class="step-title">Collaborate Live</div>
      <p class="step-desc">Add tasks, move cards, and watch everything sync in real time across every connected device.</p>
    </div>
  </div>
</section>
...
<div class="cta-band" id="cta">
  <h2 class="section-h2">Ready to collaborate in real time?</h2>
  <p class="section-desc">Join teams already using LiveCollab to move faster and stay in sync.</p>
  <a href="/register" class="hero-cta">
    Create your free workspace <span class="cta-arrow">→</span>
  </a>
</div>

<!-- FOOTER -->
<footer>
  <div class="footer-logo">LIVECOLLAB</div>
  ...
  <div class="footer-copy">© 2025 LiveCollab</div>
</footer>
